# Ubuntu/Pop!\_OS/Debian plugin

This plugin adds completions and aliases for APT.

To use it, add `ubuntu`, `pop` or `debian` to the plugins array in your initrc file:
...
Adapted for the Ion Shell by [@AdminXVII](https://gitlab.com/AdminXVII)
